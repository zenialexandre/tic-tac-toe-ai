...
def handle_player_action(pygame, display_surface, board_lines_color, grid_quadrants):
...
def draw_x_symbol(pygame, display_surface, board_lines_color, quadrant):
    ...
    elif (quadrant[0] == 'second_quadrant'):
    ...
    elif (quadrant[0] == 'third_quadrant'):
    ...
    elif (quadrant[0] == 'fourth_quadrant'):
    ...
    elif (quadrant[0] == 'fifth_quadrant'):
    ...
    elif (quadrant[0] == 'sixth_quadrant'):
    ...
    elif (quadrant[0] == 'seventh_quadrant'):
    ...
    elif (quadrant[0] == 'eighth_quadrant'):
